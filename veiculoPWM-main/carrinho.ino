...
AF_DCMotor motorLft(4); // Motores da esquerda serão no pino 2 da placa
AF_DCMotor mototRgt(3); // Motores da direita serão no pino 4 da placa
...
void loop(){
   ...
   */
    ...
    */
  if (distancia < 30 and distancia > 20){
    deslig();
    int distancia = lerDistancia();
